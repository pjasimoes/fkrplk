...
c 5-2-2001 /univ/ and /univ1/ were moved fkrplk_par.h                  c
...
c
            ...
            do 2 m=0,ntau,ntauwr
               do 3 l=-nmu,nmu
                  write(10,202) (phi(jj,k,l,m), k=0,newr)
 3             continue
 2          continue
c
c  get back on step
...
c
      ...
      IF (ITICK /= 0)                                                  
     1WRITE (6,'(" Processing complete in ", F9.3, " seconds")')       
     2      REAL(ITIME-TIME0)/REAL(ITICK)
      end